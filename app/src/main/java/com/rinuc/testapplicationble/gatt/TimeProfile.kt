package com.rinuc.testapplicationble.gatt
...
object TimeProfile {
  ...
  fun createTimeService(): BluetoothGattService {
    ...
    val currentTime = BluetoothGattCharacteristic(CURRENT_TIME,
      ...
      BluetoothGattCharacteristic.PERMISSION_READ or PERMISSION_WRITE)
    val configDescriptor = BluetoothGattDescriptor(CLIENT_CONFIG,
      //Read/write descriptor
      BluetoothGattDescriptor.PERMISSION_READ or PERMISSION_WRITE
    )
